...
export const EditForm = () => {
    ...
    const [selectedDependency, setSelectedDependency] = useState(
        formState.dependencia
    );
    const [selectedPlantel, setSelectedPlantel] = useState(formState.plantel);
    ...
    const handleSubmit = async (e) => {
        ...
        const resp = await axios.put(
            'http://localhost:3000/api/employee/' + state.id,
            formState
        );
    ...
    const [selectedOption, setSelectedOption] = useState(formState.estatus);
                ...
                <div className={Styles.columna}>
                    ...
                    <label className={Styles.checks}>
                        <input
                            type="radio"
                            checked={
                                formState.nacionalidad == 'mexicana'
                                    ? true
                                    : false
                            }
                            name="nacionalidad"
                        ...
                        <input
                            type="radio"
                            checked={
                                formState.nacionalidad == 'extranjera'
                                    ? true
                                    : false
                            }
                            name="nacionalidad"
                ...
                <div className={Styles.columna}>
                    ...
                    <label>
                        ...
                        <select
                            ...
                            value={formState.lugarNacimiento}
                            onChange={(e) => {
                                setFormstate({
                                    ...formState,
                    ...
                    <label>
                        ...
                        <select
                            name="escolaridad"
                            selected={formState.escolaridad}
                            value={formState.escolaridad}
                            onChange={(e) => {
                                setFormstate({
                                    ...formState,
                ...
                <div className={Styles.columna}>
                    ...
                    <label className={Styles.checks}>
                        <input
                            ...
                            value="masculino"
                            checked={
                                formState.genero == 'masculino' ? true : false
                            }
                            onChange={(e) => {
                                setFormstate({
                                    ...formState,
                        ...
                        <input
                            ...
                            value="femenino"
                            checked={
                                formState.genero == 'femenino' ? true : false
                            }
                            onChange={(e) => {
                                setFormstate({
                                    ...formState,
                ...
                <div className={Styles.columna}>
                    ...
                    <label>
                        ...
                        <select
                            ...
                            value={formState.tipoDependencia}
                            onChange={(e) => {
                                setFormstate({
                                    ...formState,
                ...
                <div className={Styles.columna}>
                    ...
                    <label>
                        ...
                        <input
                            ...
                            value={formState.fechaSolicitud}
                            type="date"
                            name="fechaSolicitud"
                        />
                    </label>
                ...
                <div className={Styles.columna}>
                    ...
                    <label>
                        ...
                        <input
                            ...
                            type="date"
                            value={formState.fechaIngresoSTSPE}
